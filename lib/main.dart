    ...
    return Scaffold(
      ...
      body: Container(
        ...
        padding: const EdgeInsets.only(
            top: 100), // Add padding to move the content down
        child: Column(
          mainAxisSize: MainAxisSize.min, // Use minimum size for the column
          children: [
            const Text(
              'Shielded Voice !', // Text above the image
              style: TextStyle(
                fontSize: 30.0,
              ...
              return DropdownMenuItem<String>(
                ...
                child: Text(language,
                    style: const TextStyle(
                        color: Colors.black)), // Black text for items
              );
            }).toList(),
...
class RegisterPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:
          const Color(0xFF9775FA), // Background color from the design
      resizeToAvoidBottomInset:
          true, // Prevent bottom overflow when keyboard appears
      body: SingleChildScrollView(
        // Allows the screen to scroll if the content overflows
        child: ConstrainedBox(
          constraints: BoxConstraints(
            minHeight: MediaQuery.of(context)
                .size
                .height, // Ensure content fills the screen height
          ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(
                      height: 20.0), // Spacing between the title and fields
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(
                          ...
                          borderSide: const BorderSide(
                              color: Colors.white), // Adjusted border radius
                        ),
                        enabledBorder: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(16.0),
                          borderSide: const BorderSide(
                              color: Colors
                                  .white), // Dark border color when not focused
                        ),
                        filled: true,
                        fillColor: const Color(
                            0xFF9775FA), // Purple background for the input
                        contentPadding: const EdgeInsets.symmetric(
                            vertical: 10.0,
                            horizontal: 15.0), // Adjust internal padding
                      ),
                    ),
                  ),
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(
                              50.0), // Rounded button edges
                        ),
                      ),
                      onPressed: () {
                        _showRegistrationMessage(
                            context); // Show success message on click
                      },
                      child: const Text(
                        'Register',
                        style: TextStyle(
                      ...
                      children: [
                        ...
                        IconButton(
                          icon: const Icon(Icons.mail,
                              size: 20.0), // Placeholder for Google icon
                          onPressed: () {
                        ...
                        IconButton(
                          icon: const Icon(Icons.camera_alt,
                              size: 20.0), // Placeholder for Instagram icon
                          onPressed: () {
                        ...
                        IconButton(
                          icon: const Icon(Icons.facebook,
                              size: 20.0), // Placeholder for Facebook icon
                          onPressed: () {
...
class SignUpPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        // Allows the screen to scroll when the keyboard appears
        child: SizedBox(
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(
                        height:
                            10.0), // Space between email and password fields
                    ...
                    const SizedBox(
                        height:
                            20.0), // Space between password and social buttons
                    ...
                    const SizedBox(
                        height:
                            20.0), // Space between register and login button
          ...
          GestureDetector(
            onTap: () {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        const ProfilePage()), // Change to ProfilePage
              );
            },
            child: ClipOval(
              child: Container(
        ...
        children: [
          Padding(
            ...
            child: Column(
              ...
              children: [
                const Text(
                  'Courage to Speak, Power to Change!',
                  style: TextStyle(
                    fontSize: 24.0,
                    fontWeight: FontWeight.bold,
                    color: Colors.white,
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor:
                            const Color.fromARGB(255, 253, 252, 250),
                        foregroundColor: Colors.black,
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(20.0),
                        ),
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  const AboutUsPage()), // Change to AboutUsPage
                        );
                      },
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.white,
      ...
      onTap: () {
        if (title == 'Petition') {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => const ForumPage()), // Update to ForumPage
          );
        }
      },
      child: SizedBox(
...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          const SizedBox(height: 50), // Moves profile picture up from the center
          Center(
            child: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    // Navigate back to the RegisterPage on logout
                    Navigator.pushReplacement(
                      context,
...
class ConsultancyPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255,242,210,195),
      body: Column(
        children: [
          ...
          Expanded(
            ...
            child: Container(
              width: double.infinity,
              color: const Color(
                  0xFF9C89F6), // Background color to match the purple area
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset(
                        ...
                        child: IconButton(
                          onPressed: () {
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      const SupportPage()), // Navigating to SupportPage
                            );
                          },
                          icon: const Icon(
                            Icons.arrow_forward,
          ...
          Expanded(
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage(
                      'assets/consult.png'), // Replace with your header image path
                  fit: BoxFit.cover,
                ),
              ),
            ),
            ...
            child: Padding(
              ...
              child: GridView.count(
                ...
                children: [
                  _buildSupportCard(
                    context,
                    imagePath: 'assets/new2.png',
                    title: 'Post Traumatic Stress Disorder(PTSD)',
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const TraumaPage()),
                      );
                    },
                  ),
                  _buildSupportCard(
                    context,
                    imagePath: 'assets/new3.png',
                    title: 'Depression',
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const DepressionPage()),
                      );
                    },
                  ),
                  _buildSupportCard(
                    context,
                    imagePath: 'assets/new4.png',
                    title: 'Anxiety Disorder',
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const AnxietyDisorderPage()),
                      );
                    },
                  ),
                  _buildSupportCard(
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                const DissociativeDisorderPage()),
                      );
                    },
                  ),
                ],
...
class _TraumaPageState extends State<TraumaPage> {
  ...
  void initState() {
    ...
    _controller2 = YoutubePlayerController(
      initialVideoId:
          'YOUR_SECOND_VIDEO_ID', // Replace with your second YouTube video ID
      flags: const YoutubePlayerFlags(
        autoPlay: false,
        mute: false,
      ),
...
class PsychiatristListPage extends StatelessWidget {
  final List<Psychiatrist> psychiatrists = [
    // Your existing list of psychiatrists...
    const Psychiatrist(
    ...
    const Psychiatrist(
      ...
      bio:
          "Dedicated to improving mental well-being through holistic treatment.",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Padding(
          padding:
              const EdgeInsets.all(8.0), // Add padding to avoid edge cutoffs
          child: ListView.builder(
            shrinkWrap: true, // Prevent overflow by shrinking the ListView
            itemCount: psychiatrists.length,
            itemBuilder: (context, index) {
              return Card(
                // Optional: Wrapping with a Card to enhance UI
                color: const Color(0xFF6C4E9F),
...
class _DepressionPageState extends State<DepressionPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // Bottom Navigation Bar with BottomAppBar
      bottomNavigationBar: BottomAppBar(
        shape: const CircularNotchedRectangle(),
        notchMargin: 8.0,
        child: Row(
...
class _AnxietyDisorderPageState extends State<AnxietyDisorderPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // Bottom Navigation Bar
      bottomNavigationBar: BottomAppBar(
        color: const Color(0xFF9775FA), // Purple background for bottom bar
        child: Padding(
            ...
            children: [
              ...
              IconButton(
                icon: const Icon(Icons.warning_amber_outlined,
                    color: Colors.white),
                onPressed: () {
                  // Navigate to favorites or appropriate page
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const petitionpage1()),
              ...
              IconButton(
                ...
                onPressed: () {
                  // Navigate to notifications or appropriate page
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const petitionpage1()),
              ...
              IconButton(
                ...
                onPressed: () {
                  // Navigate to account or appropriate page
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const ConsultancyPage()),
...
class DissociativeDisorderPage extends StatefulWidget {
  ...
  @override
  _DissociativeDisorderPageState createState() =>
      _DissociativeDisorderPageState();
}
                  ...
                  Row(
                    ...
                    children: [
                      IconButton(
                        onPressed: () {
                          Navigator.pop(
                              context); // Goes back to the previous campaign
                        },
                ...
                Row(
                  children: [
                    Padding(
                      ...
                      child: Image(
                        image: AssetImage(
                            'assets/img.png'), // Replace with the path to your image
                        width: 50,
                        height: 50,
                        fit: BoxFit.cover,
                      ),
                ...
                Text.rich(
                  TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text:
                            'Please ensure all information is accurate and respectful. Petitions are intended to drive real change, so honest, thoughtful contributions make a big difference.',
                        style: TextStyle(fontSize: 15, color: Colors.white),
                      ),
                    ],
                  ),
                ...
                Text.rich(
                  TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text:
                            'Our petition platform is for promoting safety, justice, and well-being. Petitions should support causes that align with our mission of protecting individuals and promoting equity.',
                        style: TextStyle(fontSize: 15, color: Colors.white),
                      ),
                    ],
                  ),
                ...
                Text.rich(
                  TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text:
                            'Petitions with false claims or those that violate our terms may be removed to maintain a safe and credible space for everyone.',
                        style: TextStyle(fontSize: 15, color: Colors.white),
                      ),
                    ],
                  ),
...
class PetitionPage2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            IconButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const PetitionPage3()),
                );
              },
            ),
          ],
      ...
      // FloatingActionButton for navigating to the next petition page
      floatingActionButton: FloatingActionButton(
        backgroundColor: Colors.white,
        child: const Icon(
          Icons.arrow_forward,
                      ...
                      IconButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const storypage1()),
                          );
                        },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        children: [
          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  const Color.fromARGB(255, 151, 117, 250)
                      .withOpacity(0.5), // Light purple overlay
                  const Color.fromARGB(255, 151, 117, 250)
                      .withOpacity(0.7), // Darker purple towards bottom
                ],
                begin: Alignment.topCenter,
                end: Alignment.bottomCenter,
              ),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          BottomNavigationBarItem(
            icon: Icon(Icons.warning, color: const Color(0xFF9775FA)),
            label: '',
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.people, color: const Color(0xFF9775FA)),
            label: '',
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.chat, color: const Color(0xFF9775FA)),
            label: '',
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.chat, color: const Color(0xFF9775FA)),
          ...
          child: Column(
            ...
            children: [
              ...
              Text.rich(
                TextSpan(
                  text:
                      'Signature', // Signature part, bold, purple, and bigger size
                  style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                  ...
                  children: <TextSpan>[
                    TextSpan(
                      text:
                          '(press enter after you put your name):', // Smaller and regular text
                      style: TextStyle(
                        fontSize: 14, // Smaller font size
                        fontWeight: FontWeight.normal, // Normal font weight
                        color: Colors
                            .black, // Set color to black for the rest of the text
                      ),
                    ),
                  ],
                ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('First Name',
                      style: TextStyle(fontSize: 18, color: Color(0xFF9775FA))),
            ...
            children: [
              ...
              const TextField(
                ...
                decoration: InputDecoration(
                  border: OutlineInputBorder(),
                  hintText:
                      'Street name / Landmark / House / Specific place where the incident happened / Unknown',
                ),
              ),
              const SizedBox(height: 20),
              ...
              const TextField(
                ...
                decoration: InputDecoration(
                  border: OutlineInputBorder(),
                  hintText:
                      'Any Relatives / Father / specify the relation with you',
                ),
              ),
              const SizedBox(height: 20),
              ...
              DropdownButtonFormField<String>(
                ...
                items:
                    ['Unknown', '1', '2', '3', '4', '5+'].map((String value) {
                  return DropdownMenuItem<String>(
                    value: value,
                    child: Text(value),
                  );
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Noticeable mark:',
              style: TextStyle(
                  fontSize: 16, color: Color(0xFF9775FA)), // purple color
            ),
            const SizedBox(height: 16),
            const TextField(
              decoration: InputDecoration(
          ...
          children: [
            ...
            const Text(
              ...
              overflow: TextOverflow
                  .ellipsis, // Add ellipsis if text exceeds the available width
            ),
            const Row(
              children: [
                Row(
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            ReportIncidentScreen()), // Replace NextScreen with your target screen
                  );
                },
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const GoFundMePage2()),
                );
              },
              style: ElevatedButton.styleFrom(
                padding:
            ...
            IconButton(
              ...
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          const PetitionPage2()), // Replace with your petitionpage1
                );
              },
            ),
          ],
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                children: [
                  const Text(
                    'I grew up in a small village with limited opportunities. Despite the hardships, I was a bright, curious girl who loved reading and dreamed of becoming a teacher...'
                    '\n\nOne evening, on my way home, I was assaulted by someone from my village...',
                    style: TextStyle(
                      fontSize: 16,
                      color: Colors.black87,
                    ),
                      ...
                      IconButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const GoFundMePage3()),
                          );
                        },
                        icon: const Icon(Icons.arrow_forward_ios,
                            color: Colors.purple),
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const GoFundMe3Page()),
                      );
                    },
                    style: ElevatedButton.styleFrom(
                      padding: const EdgeInsets.symmetric(
        ...
        child: Column(
          children: [
            ...
            const Padding(
              ...
              child: Text(
                'I grew up in a close-knit neighborhood, where everyone knew each other, and I felt safe. I had big dreams, hoping one day to make a difference in my community, but life took an unexpected turn...'
                'With therapy and the support of this newfound community, I started reclaiming my voice and my strength.',
                style: TextStyle(
                  fontSize: 14,
                  color: Colors.black,
                ),
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      dropdownColor: const Color(0xFF9775FA),
                      items: const [
                        DropdownMenuItem(
                            value: 'CBE',
                            child: Text('CBE',
...
class _ReportIncidentScreenState extends State<ReportIncidentScreen> {
  ...
  Future<void> sendIncidentDetails(String details) async {
    const apiKey =
        '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';
    ...
    try {
      final response = await http.post(
        ...
        body: jsonEncode({
          ...
          "prompt":
              "Provide guidance based on the following incident report: $details",
          "max_tokens": 150,
        }),
      );
      ...
      if (response.statusCode == 200) {
        ...
        if (choices != null && choices.isNotEmpty) {
          setState(() {
            _response = choices[0]['text'].trim();
          });
        } else {
          setState(() {
            _response = "No response generated from AI.";
          });
        }
      } else {
        setState(() {
          ...
          child: Column(
            ...
            children: [
              TextField(
                controller: _controller,
                decoration: const InputDecoration(
                  labelText: 'How are you feeling now?',
                  border: OutlineInputBorder(),
                ),
              ...
              ElevatedButton(
                onPressed: () {
                  if (_controller.text.isNotEmpty) {
                    sendIncidentDetails(_controller.text);
                  }
                },
